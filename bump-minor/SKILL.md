...
name: bump-minor
description: >
  Increment minor version (e.g. 1.1.2 -> 1.2.0) across all project files.
  Trigger on "/bump-minor", "bump minor".
...
Increment the **minor** version across all project files. No questions — just do it.

## What it does

- `1.1.2` → `1.2.0` (patch resets to 0)
...
4. Bump minor: `major.minor.patch` → `major.(minor+1).0`
...
```
✅ bump-minor: 1.1.2 → 1.2.0 (build 46 → 47)

| Arquivo         | Campo                      | Antes | Depois |
|-----------------|----------------------------|-------|--------|
| package.json    | version                    | 1.1.2 | 1.2.0  |
| app.json        | expo.version               | 1.1.2 | 1.2.0  |
